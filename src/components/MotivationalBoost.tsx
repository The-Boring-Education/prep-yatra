...
const MotivationalBoost = ({ challenges, className = '' }: MotivationalBoostProps) => {
  ...
  const shareAchievement = async () => {
    const achievementText = `🎉 Just earned the "${achievement.text}" badge on my learning journey!
...
#PrepYatra #LearningJourney #ChallengeAccepted #ConsistencyIsKey`;
  ...
  if (challenges.length === 0) {
    return (
      <Card className={`bg-gradient-to-br from-primary/10 to-purple-600/10 border-primary/20 ${className}`}>
        <CardContent className="pt-6">
          <div className="text-center space-y-4">
            ...
            <div>
              ...
              <p className="text-gray-300 text-sm mb-4">"{randomQuote.text}"</p>
              <p className="text-gray-400 text-xs">- {randomQuote.author}</p>
            </div>
          </div>
        </CardContent>
      </Card>
        ...
        <div className="space-y-4">
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h3 className="font-semibold text-white">{achievement.text}</h3>
                <p className="text-sm text-gray-400">Keep up the amazing work!</p>
              </div>
            </div>
            <Button
              variant="outline"
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div className="text-center">
              <div className="flex items-center justify-center gap-1 text-blue-400 mb-1">
                ...
                <span className="text-lg font-bold">{activeChallenges.length}</span>
              </div>
            ...
            <div className="text-center">
              <div className="flex items-center justify-center gap-1 text-purple-400 mb-1">
                ...
                <span className="text-lg font-bold">{Math.round(averageProgress)}%</span>
              </div>
          ...
          <div className="border-t border-primary/20 pt-4">
            ...
            <p className="text-xs text-gray-400 text-center mt-2">- {randomQuote.author}</p>
          </div>
        </div>
      </CardContent>
    </Card>
