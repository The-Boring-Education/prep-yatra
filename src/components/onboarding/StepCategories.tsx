...
type Props = {
  ...
  toggleArrayField: (field: 'preferredCategories', value: InterviewCategory) => void;
};

const StepCategories: React.FC<Props> = ({ formData, toggleArrayField }) => (
  <div className='space-y-6'>
    <div className='text-center mb-8'>
      <h1 className='text-2xl font-bold text-white mb-2'>What would you like to focus on? 📚</h1>
      <p className='text-gray-300'>Choose your preparation areas</p>
    </div>
    <div className='grid grid-cols-1 sm:grid-cols-2 gap-4'>
      {INTERVIEW_CATEGORIES.map((category) => (
        ...
        >
          ...
          <div className='font-medium text-white mb-1'>{category.label}</div>
