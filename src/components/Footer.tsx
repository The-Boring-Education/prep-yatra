        ...
        <div className="flex flex-col lg:flex-row items-start justify-between gap-8 w-full">
          ...
          <div className="w-full lg:w-1/2 flex flex-col lg:flex-row lg:justify-end gap-10">
            ...
            <div className="flex flex-col gap-2 w-full lg:w-auto">
              <span className="text-gray-300 font-semibold text-sm mb-1 text-left">Contribute</span>
              <div className="flex flex-col gap-2 items-start text-left lg:items-end lg:text-right">
                <a
                  href="https://github.com/The-Boring-Education/prep-yatra"
                  target="_blank"
                  rel="noopener noreferrer"
            ...
            {/* Products Section */}
            <div className="flex flex-col gap-2 w-full lg:w-auto">
              <span className="text-gray-300 font-semibold text-sm mb-1 text-left">Our Products</span>
              <div className="flex flex-col gap-2 items-start text-left lg:items-end lg:text-right">
