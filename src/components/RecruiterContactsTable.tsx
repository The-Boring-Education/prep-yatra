...
const RecruiterContactsTable = ({ contacts, onContactsChange }: RecruiterContactsTableProps) => {
  ...
  if (contacts.length === 0) {
    return (
      <div className="glass-dark rounded-2xl p-8 text-center">
        ...
        <p className="text-gray-300">Start building your recruiter network by adding your first contact!</p>
      </div>
    );
  }
  ...
  return (
    <div className="glass-dark rounded-2xl p-6">
      <div className="flex justify-between items-center mb-6">
        <h3 className="text-xl font-bold text-white">Your Recruiter Network</h3>
        ...
        <Table>
          ...
          <TableBody>
            {contacts.map((contact) => (
              <TableRow key={contact.id} className="border-primary/10 hover:bg-primary/5 transition-colors">
                ...
                <TableCell className="text-gray-300">{contact.position}</TableCell>
