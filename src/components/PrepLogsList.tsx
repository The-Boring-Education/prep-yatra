...
const PrepLogCard = ({ logs, onLogUpdated, mongoUserId }: Props) => {
  ...
  const handleDelete = async () => {
    ...
    try {
      const res = await fetch(
        `${import.meta.env.VITE_TBE_BACKEND}/api/v1/prep-yatra/prep-log?prepLogId=${deleteId}`,
        {
          method: "DELETE",
        }
      )
  ...
  if (logs.length === 0) {
        return (
          <div className="mt-8">
            <h2 className="text-2xl font-bold text-white mb-4">📚 Your Prep Logs</h2>
                    ...
                    <AlertDialogContent className="bg-gray-800 border-primary/20">
                      <AlertDialogHeader>
                        ...
                        <AlertDialogDescription className="text-gray-300">
                          Are you sure you want to delete this prep log? This
