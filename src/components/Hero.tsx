      ...
      <div className="container mx-auto text-center relative z-10">
        <div className="animate-fade-in">
          <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold text-white mb-6 leading-tight">
            Turn <span className="text-primary animate-pulse">Hustle</span>
            <br />
            Into <span className="text-primary animate-pulse">Hires</span>
          </h1>
        ...
        <div className="grid md:grid-cols-3 gap-6 mt-16">
          <div className="glass rounded-2xl p-6 animate-slide-in-left hover:scale-105 transition-transform duration-300">
            ...
            <h3 className="text-white font-semibold mb-2">📞 Recruiter Network</h3>
            <p className="text-gray-300 text-sm">Build and manage your professional recruiter contacts database</p>
          </div>
          
          <div className="glass rounded-2xl p-6 animate-scale-in hover:scale-105 transition-transform duration-300" style={{animationDelay: '0.2s'}}>
            <div className="w-16 h-16 bg-primary rounded-full mx-auto mb-4 flex items-center justify-center">
              <svg className="w-8 h-8 text-primary-foreground" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
              </svg>
            </div>
            <h3 className="text-white font-semibold mb-2">📝 Prep Logs</h3>
            <p className="text-gray-300 text-sm">Track your interview preparation progress and learnings</p>
          </div>
          
          <div className="glass rounded-2xl p-6 animate-slide-in-right hover:scale-105 transition-transform duration-300" style={{animationDelay: '0.4s'}}>
            <div className="w-16 h-16 bg-primary rounded-full mx-auto mb-4 flex items-center justify-center">
              <svg className="w-8 h-8 text-primary-foreground" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8.684 13.342C8.886 12.938 9 12.482 9 12c0-.482-.114-.938-.316-1.342m0 2.684a3 3 0 110-2.684m0 2.684l6.632 3.316m-6.632-6l6.632-3.316m0 0a3 3 0 105.367-2.684 3 3 0 00-5.367 2.684zm0 9.316a3 3 0 105.367 2.684 3 3 0 00-5.367-2.684z" />
              </svg>
            </div>
            <h3 className="text-white font-semibold mb-2">🔄 Resource Sharing</h3>
            <p className="text-gray-300 text-sm">Share and discover valuable job search resources with the community</p>
          </div>
        </div>
      </div>
    </section>
