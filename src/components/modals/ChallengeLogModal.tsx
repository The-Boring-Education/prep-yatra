...
Check out Prep Yatra if you want to start your own challenge! ${appUrl}`,
      ...
      `📚 Learning Update: Day ${nextDay}/${challenge.totalDays} - ${challenge.name}
        ...
        <DialogContent className="sm:max-w-[500px] glass-dark border-primary/20">
          ...
          <Card className="bg-gradient-to-r from-yellow-500/20 to-orange-500/20 border-yellow-500/30">
            <CardContent className="pt-6 text-center">
              ...
              <h3 className="text-lg font-semibold text-white mb-2">Amazing Achievement!</h3>
              <p className="text-gray-300 mb-4">
                You've successfully completed all {challenge.totalDays} days of your challenge. 
        ...
        {!showSocialPreview ? (
          <>
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-3">
                <Label className="text-white">What are your goals for tomorrow?</Label>
                <div className="space-y-2">
              ...
              <div className="flex items-center space-x-2">
                <Checkbox
                  ...
                  onCheckedChange={(checked) => setCopyToPrepLogs(checked as boolean)}
                />
              ...
              <Card className="bg-gray-800/30 border-gray-600">
                <CardHeader className="pb-3">
                  <CardTitle className="text-sm text-white">Challenge Progress</CardTitle>
                </CardHeader>
                <CardContent className="space-y-2 text-sm">
                  <div className="flex justify-between">
                    <span className="text-gray-400">Current Day:</span>
                    <span className="text-white">{challenge.currentDay}</span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-gray-400">Next Day:</span>
                    <span className="text-white">{nextDay}</span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-gray-400">Total Days:</span>
                    <span className="text-white">{challenge.totalDays}</span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-gray-400">Progress:</span>
                    <span className="text-white">{Math.round((nextDay / challenge.totalDays) * 100)}%</span>
                  </div>
                </CardContent>
              </Card>
            </div>
            ...
            <DialogFooter>
              <Button onClick={onClose} variant="outline" className="border-gray-300 text-white hover:bg-gray-100 hover:text-gray-900">
                ...
                disabled={loading || !formData.progressText.trim() || !formData.hoursSpent}
          ...
          <>
            <DialogHeader>
              ...
              <DialogDescription className="text-gray-300">
                Choose a template to share your Day {nextDay} progress
              </DialogDescription>
            </DialogHeader>
            ...
            <div className="space-y-4">
              ...
              <div className="flex flex-wrap gap-2">
                  <Button
                  onClick={() => copyToClipboard(generateSocialMessageFromTemplate(selectedTemplate))}
                    variant="outline"
                    size="sm"
