  ...
  return (
    <Card className={`bg-gradient-to-br from-primary/10 to-purple-600/10 border-primary/20 ${className}`}>
      <CardHeader>
        ...
        <CardDescription>
          Share your learning journey and inspire others to start their own challenges
        </CardDescription>
      </CardHeader>
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-sm text-gray-400">
              Day {challenge.currentDay} of {challenge.totalDays} • {progressPercentage}% complete
            </p>
          </div>
