  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const payload = {
        ...
        ...(editLog ? { prepLogId: editLog._id } : { userId: mongoUserId }),
      }

      const res = await fetch(
        `${import.meta.env.VITE_TBE_BACKEND}/api/v1/prep-yatra/prep-log`,
        {
      ...
      toast({
        title: "Success",
        description: `Prep Log ${editLog ? "updated" : "added"} successfully!`,
      })
