            ...
            <div className="space-y-3">
              <div className="flex items-center gap-2 text-gray-300">
                ...
                <span className="text-sm">
                  <strong>Experience:</strong> {profile?.experience_level ? formatExperienceLevel(profile.experience_level) : 'Not specified'}
                </span>
              </div>
          ...
          <div className="glass-dark rounded-2xl p-6">
            ...
            <div className="space-y-4">
              <div className="text-center">
                ...
                <p className="text-gray-300 text-sm">Active Contacts</p>
              </div>
              ...
              {recruiterContacts.length > 0 && (
                <div className="text-center pt-2">
                  <p className="text-gray-400 text-sm">
                    Last contact added {new Date(recruiterContacts[0]?.created_at).toLocaleDateString()}
                  </p>
                </div>
              )}
            </div>
        ...
        <div className="mt-8 text-center">
          <div className="glass-dark rounded-2xl p-8">
            ...
            <div className="flex gap-4 justify-center">
              ...
              >
                🚀 {recruiterContacts.length === 0 ? 'Add First Contact' : 'Add More Contacts'}
              </Button>
            </div>
          </div>
        </div>
